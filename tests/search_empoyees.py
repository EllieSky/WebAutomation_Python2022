...
class SearchEmployees(unittest.TestCase):
    ...
    def test_search_by_id(self):
        ...
        self.wait.until(EC.presence_of_element_located((By.ID, 'welcome')))

        # example of try/except block
        try:
            browser.find_element(By.ID, 'empsearch_i').send_keys(expected_emp_id)
        except NoSuchElementException:
            browser.find_element(By.ID, 'empsearch_id').send_keys(expected_emp_id)

        browser.find_element(By.NAME, '_search').click()
        self.wait.until(EC.text_to_be_present_in_element_attribute((By.ID, 'empsearch_id'), 'value', expected_emp_id))
    ...
    def test_search_by_employment_status(self):
        ...
        self.wait.until(EC.element_attribute_to_include(
